<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold text-slate-900">Create Grading Period</h1>
        </div>
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        <section class="content-card">
            <form method="POST" action="{{ route('admin.academic-setup.grading-periods.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <x-primary-button>Create grading period</x-primary-button>
                </div>
            </form>
        </section>
    </div>
